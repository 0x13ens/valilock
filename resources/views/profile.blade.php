                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-7 text-md-left text-center mt-4 mt-sm-0">
                                                ...
                                                <ul class="list-inline mb-0 mt-3">
                                                    ...
                                                    <li class="list-inline-item"><a href="javascript:void(0)" class="text-muted" title="Skype"><i class="mdi mdi-skype mr-2"></i>@krista_joseph</a></li>
                                                </ul>
                                            </div><!--end col-->
                                            <div class="col-md-5 text-md-right text-center">
                                                <ul class="list-unstyled profile-icons mb-0 mt-4">
                                                    <li class="list-inline-item"><a href="javascript:void(0)" class="rounded-pill"><i class="mdi mdi-plus" title="Add Friend"></i></a></li>
                                                    <li class="list-inline-item"><a href="javascript:void(0)" class="rounded-pill"><i class="mdi mdi-email" title="Messages"></i></a></li>
                                                    <li class="list-inline-item"><a href="javascript:void(0)" class="rounded-pill"><i class="mdi mdi-bell" title="Notifications"></i></a></li>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-5 col-12">
                    <div class="p-4 rounded shadow">
                        ...
                        <h5 class="mt-4 pt-2">Followers :</h5>
                        <div class="row mt-4">
                            ...
                            <div class="col-6 text-center">
                                <i class="mdi mdi-account-plus-outline mdi-24px text-primary"></i>
                                <h5 class="mb-0">454</h5>
                                <p class="text-muted mb-0">Following</p>
                            </div><!--end col-->
                        </div><!--end row-->

                        <h5 class="mt-4 pt-2">Follow me :</h5>
                        ...
                        <div class="row">
                            <div class="col-lg-6 mt-4 pt-2">
                                <div class="blog position-relative overflow-hidden shadow rounded">
                                    ...
                                    <div class="author">
                                        <small class="text-light user d-block"><i class="mdi mdi-account"></i> Krista Joseph</small>
